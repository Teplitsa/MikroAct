...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Collective.location_point'
        db.alter_column(u'accounts_collective', 'location_point', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Collective.location_point'
        raise RuntimeError("Cannot reverse this migration. 'Collective.location_point' and its values cannot be restored.")
