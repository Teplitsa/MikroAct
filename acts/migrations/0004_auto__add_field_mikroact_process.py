...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MikroAct.process'
        db.add_column(u'acts_mikroact', 'process',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MikroAct.process'
        db.delete_column(u'acts_mikroact', 'process')
    ...
    models = {
        ...
        u'acts.mikroact': {
            ...
            'process': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '255'}),
