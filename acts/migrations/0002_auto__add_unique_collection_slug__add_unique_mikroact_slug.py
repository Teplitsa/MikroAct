...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'acts_collection', ['slug'])

        # Adding unique constraint on 'MikroAct', fields ['slug']
        db.create_unique(u'acts_mikroact', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'MikroAct', fields ['slug']
        db.delete_unique(u'acts_mikroact', ['slug'])

        # Removing unique constraint on 'Collection', fields ['slug']
        db.delete_unique(u'acts_collection', ['slug'])
