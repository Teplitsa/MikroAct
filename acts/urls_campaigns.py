...
from .views import CampaignListView, CampaignCreateView, CampaignUpdateView, \
        CampaignFollowView, CampaignUnFollowView, CampaignDetailView
...
urlpatterns = patterns('',
    ...
    url(r'(?P<slug>[-_\w]+)/unfollow/$', CampaignUnFollowView.as_view(), name='campaign_unfollow'),
