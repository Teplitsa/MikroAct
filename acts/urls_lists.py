...
from .views import CollectionListView, CollectionCreateView, CollectionUpdateView, CollectionFollowView, CollectionDetailView
...
urlpatterns = patterns('',
    ...
    url(r'(?P<slug>[-_\w]+)/follow/$', CollectionFollowView.as_view(), name='collection_follow'),
